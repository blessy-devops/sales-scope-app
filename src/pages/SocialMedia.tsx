...
export default function SocialMedia() {
  ...
  const handleRefreshAll = () => {
    ...
    queryClient.invalidateQueries({ queryKey: ['followers-analytics', year, month] });
    queryClient.invalidateQueries({ queryKey: ['sales-analytics', year, month] });
  };
